...
<%--              <c:if test="${ct.getIdCustomerType()==customer.customer_type_id}"><option selected>--%>
<%--                    ${ct.getNameCustomerType()}--%>
<%--                </option></c:if>--%>
<%--                <c:if test="${ct.getIdCustomerType()!=customer.customer_type_id}"><option>--%>
<%--                        ${ct.getNameCustomerType()}--%>
<%--                </option>--%>

                <option ${ct.getIdCustomerType()==customer.customer_type_id? 'selected' : ''}> ${ct.getNameCustomerType()}</option>
